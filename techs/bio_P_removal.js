...
function bio_P_removal(Q,bCOD,rbCOD,VFA,nbVSS,iTSS,TP,T,SRT,rbCOD_NO3_ratio,NOx,NO3_eff){
	...
	*/
	...
	return {
		Q_rbCOD:               {value:Q_rbCOD,                     unit:"g/d",      descr:"Q_rbCOD"},
		RQ_NO3_N:              {value:RQ_NO3_N,                    unit:"g/d",      descr:"RQ_NO3_N"},
		rbCOD_used_by_NO3:     {value:rbCOD_used_by_NO3,           unit:"g/d",      descr:"rbCOD_used_by_NO3"},
		...
		VFA_rbCOD_ratio:       {value:VFA_rbCOD_ratio,             unit:"&empty;",  descr:"VFA_rbCOD_ratio"},
		rbCOD_P_ratio:         {value:rbCOD_P_ratio,               unit:"&empty;",  descr:"rbCOD_P_ratio"},
		P_removal_EBPR:        {value:P_removal_EBPR,              unit:"g/m3",     descr:"P_removal_EBPR"},
		bHT:                   {value:bHT,                         unit:"1/d",      descr:"bHT"},
		bnT:                   {value:bnT,                         unit:"1/d",      descr:"bnT"},
		P_X_bio:               {value:P_X_bio,                     unit:"g/d",      descr:"P_X_bio"},
		P_removal_synthesis:   {value:P_removal_synthesis,         unit:"g/d",      descr:"P_removal_synthesis"},
		P_removal_synthesis_n: {value:P_removal_synthesis_n,       unit:"g/m3",     descr:"P_removal_synthesis_n"},
		Effluent_P:            {value:Effluent_P,                  unit:"g/m3",     descr:"Effluent_P"},
		P_X_TSS:               {value:P_X_TSS,                     unit:"g/d",     descr:"P_X_TSS"},
