...
function metals_doka(Ag,Al,As,B,Ba,Be,Br,Ca,Cd,Cl,Co,Cr,Cu,F,Fe,Hg,I,K,Mg,Mn,Mo,Na,Ni,Pb,Sb,Sc,Se,Si,Sn,Sr,Ti,Tl,V,W,Zn){
  ...
  */
  ...
  return {
    ...
    Be_sludge: {value:Be.sludge, unit:"g/m3", descr:"Beryllium in effluent sludge" },
    Be_water:  {value:Be.water,  unit:"g/m3", descr:"Beryllium in effluent water"  },
    ...
    Mo_sludge: {value:Mo.sludge, unit:"g/m3", descr:"Molybdenum effluent sludge"   },
    Mo_water:  {value:Mo.water,  unit:"g/m3", descr:"Molybdenum effluent water"    },
